...
get_header(); ?>
    ...
    <div class="row">
        <div class="fivecol marginT18">
            <img src="<?php echo get_template_directory_uri(); ?>/imagens/musicas/ideiasconcretas.png" alt="ideiasconcretas" width="524" height="522" /><br />
            <h2 class="marginT18">Ficha Técnica</h2>
            <p class="marginT18">Pedro DOM (Multi-instrumentista e Produtor), Zilla Sonoro (MC e Beatmaker), Patrick Bass (Contrabaixo), Thomaz Nunes (Guitarra) e Marcelo Zion (Guitarra e voz)</p>
            <p>
